...
function x = CellCounter(I,action,x,varargin)
...
elseif ~isfield(x,'thresholds')
    x.thresholds.minwatersize = 30;     
    x.thresholds.cell         = 0.16;   
    x.thresholds.mincellsize  = 6;     
    x.thresholds.maxcellsize  = 80;    
    x.thresholds.boundary     = 0; 
    x.thresholds.blursize     = 5;      
    x.thresholds.blurspread   = 1;      
    x.thresholds.cellpixels   = 16;     
    x.thresholds.backpercent  = 0.16;   
    x.thresholds.cellsign     = 1;
    x.thresholds.findedge     = 1;
