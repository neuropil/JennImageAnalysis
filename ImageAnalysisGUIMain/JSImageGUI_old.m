...
% --------------------------------------------------------------------
function triProp_Callback(hObject, eventdata, handles)
% hObject    handle to triProp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function chanAnlyz_Callback(hObject, eventdata, handles)
% hObject    handle to chanAnlyz (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function chanView_Callback(hObject, eventdata, handles)
% hObject    handle to chanView (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function red_chan_v_Callback(hObject, eventdata, handles)
% hObject    handle to red_chan_v (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function green_chan_v_Callback(hObject, eventdata, handles)
% hObject    handle to green_chan_v (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(hObject,'Checked','on')
...
% --------------------------------------------------------------------
function blue_chan_v_Callback(hObject, eventdata, handles)
% hObject    handle to blue_chan_v (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(hObject,'Checked','on')
set(handles.red_chan_v,'Checked','off')
...
% --------------------------------------------------------------------
function red_chan_a_Callback(hObject, eventdata, handles)
% hObject    handle to red_chan_a (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(hObject,'Checked','on')
set(handles.green_chan_a,'Checked','off')
set(handles.blue_chan_a,'Checked','off')
...
% handles    structure with handles and user data (see GUIDATA)
set(hObject,'Checked','on')
set(handles.red_chan_a,'Checked','off')
set(handles.blue_chan_a,'Checked','off')
